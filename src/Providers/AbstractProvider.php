...
abstract class AbstractProvider
{
     ...
     *     Options include `clientId`, `clientSecret`, `redirectUri`, and `resource`.
    ...
    /**
     * Returns the current value of the resource parameter.
     *
    ...
    {
        // Store the resource as it may need to be accessed later on.
